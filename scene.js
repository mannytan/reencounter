...
// ahead of the first rebuildRadiusCubes() call below, so that call can
// apply current visibility to the objects it creates.
const viewParams = {
  showWhite: true,
  showGreen: true,
  showBlue: true,
...
function applyViewVisibility() {
  arc.visible = viewParams.showWhite;
  sliceCircles.forEach((c) => (c.visible = viewParams.showGreen));
