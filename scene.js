...
// units. Cross sections can each have a different noise frequency and
// angular spread (crossFrequencyStep/crossSpreadStep added per index),
// so unlike the shared white circle, every other line's geometry is
// computed independently per cross section, every frame.
...
function updateCrossSectionGeometry(c, t) {
  ...
  const spreadParam = params.spread + c * params.crossSpreadStep;
