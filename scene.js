...
// --- 10-point star (vector shape) ---
function starShape(points, outerRadius, innerRadius) {
...
const starGeo = new THREE.ExtrudeGeometry(
  starShape(10, 0.9, 0.4),
...
const starEdgesGeo = new THREE.EdgesGeometry(starGeo);
const starWireframe = new THREE.LineSegments(starEdgesGeo, edgesMat);
star.add(starWireframe);
